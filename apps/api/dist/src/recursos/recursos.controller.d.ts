...
export declare class RecursosController {
    ...
    createSala(createSalaDto: CreateSalaDto): Promise<{
        id: string;
        nombre: string;
        creadoEn: Date;
        actualizadoEn: Date;
    ...
    findAllSalas(sede?: string, activa?: string): Promise<({
        _count: {
            sesiones: number;
            reservas: number;
        };
    ...
    updateSala(id: string, updateSalaDto: UpdateSalaDto): Promise<{
        id: string;
        nombre: string;
        creadoEn: Date;
        actualizadoEn: Date;
    ...
    createReserva(createReservaDto: CreateReservaSalaDto): Promise<{
        sesion: ({
            taller: {
                tema: string;
            };
    ...
    updateReserva(id: string, updateReservaDto: UpdateReservaSalaDto): Promise<{
        sesion: ({
            taller: {
                tema: string;
            };
